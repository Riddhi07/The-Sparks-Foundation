...
export class TaskStorageService {
  ...
  getTasks()  {
    // this.init();
    return this.http.get(environment.GET_API);
  }
  ...
  delete(id) {
    ...
    // return this.http.delete(environment.DEL_API);
    return this.http.post(environment.DEL_API,{"id":id});
  }
// return this.http.post(environment.DEL_API,{"id":id});
  /**
   ...
   */
  add(title) {
    const newTask = { id: ""+ nanoid(), name: title, completed: false };
     return this.http.post(environment.ADD_API,newTask)
